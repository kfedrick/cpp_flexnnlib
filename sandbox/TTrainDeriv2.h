...
template <class _A, class _B, template<typename _X, typename _Y> class _C> TTrainDeriv2<_A, _B, _C>::TTrainDeriv2(_A _a, _B _b)
{
}

template <class _A, class _B, template<typename _X, typename _Y> class _C> TTrainDeriv2<_A, _B, _C>::TTrainDeriv2(_A _a, _B _b, _C<_A,_B>* _c)
{
   c = _C<_A,_B>(_a,_b);
}
