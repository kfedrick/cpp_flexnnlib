...
template<typename T>
Array2D<double> TestSingleLayerNNActivation<T>::parse_weights(const rapidjson::Value& _obj, size_t _rows, size_t _cols)
{
...
template<typename T> NNetIO_Typ TestSingleLayerNNActivation<T>::parse_datum(const rapidjson::Value& _obj)
{
...
(TestSingleLayerNNActivation, SingleLayerNNActivation, TwoLayerFFNActivation);
INSTANTIATE_TYPED_TEST_CASE_P
(My, TestSingleLayerNNActivation, MyTypes);