...
rapidjson::Value& BasicNeuralNetSerializer::encodeNetworkLayers(rapidjson::Value &_obj, const std::vector<std::shared_ptr<NetworkLayer>>& _network_layers)
{
...
rapidjson::Value &BasicNeuralNetSerializer::encodeLayerTopology (rapidjson::Value &_obj, const std::vector<std::shared_ptr<NetworkLayer>>& _network_layers)
{
   _obj.SetArray();
