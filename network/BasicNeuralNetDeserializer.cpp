...
std::vector<std::shared_ptr<flexnnet::NetworkLayer>> flexnnet::BasicNeuralNetSerializer::parseNetworkTopology (const rapidjson::Value &_obj, std::map<std::string,
                                                                                                                                     std::shared_ptr<
...
flexnnet::BasicNeuralNetSerializer::LayerInputInfo flexnnet::BasicNeuralNetSerializer::parseExternalInput(const rapidjson::Value &_obj)
{
...
flexnnet::BasicNeuralNetSerializer::LayerInputInfo flexnnet::BasicNeuralNetSerializer::parseLayerConnections(const rapidjson::Value &_obj)
{
   LayerInputInfo layer_input_info;
...
std::map<std::string, std::shared_ptr<flexnnet::NetworkLayer>> flexnnet::BasicNeuralNetSerializer::parseNetworkLayers(const rapidjson::Value& _obj)
{
   std::map<std::string, std::shared_ptr<NetworkLayer>> layers;
...
flexnnet::LayerConnRecord::ConnectionType flexnnet::BasicNeuralNetSerializer::StringToConnType (const std::string& _typeStr)
{
   if (_typeStr == "forward")
