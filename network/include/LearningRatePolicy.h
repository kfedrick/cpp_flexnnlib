 ...
 */
   ...
   public:
      ...
      const map<string, Array < double> >&
      get_weight_learning_rates () const;
   ...
   protected:
      ...
      layer_weight_learning_rates_map;
   };
   ...
   void LearningRatePolicy::set_layer_biases_learning_rate (const string &_layerID, double _rate)
   {
      if (layer_bias_learning_rates_map.find (_layerID) == layer_bias_learning_rates_map.end ())
      {
         ...
         err_str << "Error (set_layer_biases_learning_rate() : BaseLayer ID (" << _layerID.c_str () << ") not found.";
   ...
   void LearningRatePolicy::set_layer_weights_learning_rate (const string &_layerID, double _rate)
   {
      ...
      {
         ostringstream err_str;
         err_str << "Error (set_layer_weights_learning_rate() : BaseLayer ID (" << _layerID.c_str () << ") not found.";
         throw invalid_argument (err_str.str ());
      }
   ...
   inline const map<string, Array < double> >&
   LearningRatePolicy::get_weight_learning_rates () const
   {
