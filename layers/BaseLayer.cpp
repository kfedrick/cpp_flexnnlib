...
namespace flexnnet
{
   ...
   BaseLayer::BaseLayer (const string &_name, unsigned int sz, const NetInputFunctor *netinFunc, const TransferFunctor *transFunc)
      :
      NamedObject (_name)
   {
      initialize (sz);
   ...
   void BaseLayer::initialize (unsigned int sz, const NetInputFunctor *netinFunc, const TransferFunctor *transFunc)
   {
      output_vector_size = sz;
      input_vector_size = initial_layer_input_size;
