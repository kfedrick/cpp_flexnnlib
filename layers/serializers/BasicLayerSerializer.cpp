...
{
   /*
    * Add basiclayer identity information
    */
   _obj.SetObject();
...
flexnnet::BasicLayerSerializer::BasicLayerInfo flexnnet::BasicLayerSerializer::parseBasic(const rapidjson::Value& _obj)
{
   ...
   // Save flag indicating this is an output basiclayer
   network_layer_info.is_output_layer = _obj["is_output_layer"].GetBool();

   // Save basiclayer dimension information
   ...
   // Save basiclayer weights information - resize weights as required
