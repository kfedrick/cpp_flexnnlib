...
#ifndef FLEX_NEURALNET_MYEUCLIDEANDIST_H_
#define FLEX_NEURALNET_MYEUCLIDEANDIST_H_

#include "Array.h"

namespace flexnnet
{
   class MyEuclideanDist
   {
   public:
      MyEuclideanDist(unsigned int _netvec_sz);
      ~MyEuclideanDist();
   ...
   private:
      bool stale_flag;
      std::vector<double> squared_euclidean_dist;
   ...
   inline void MyEuclideanDist::resize(unsigned int _layer_sz, unsigned int _rawin_sz)
   {
...
#endif //FLEX_NEURALNET_MYEUCLIDEANDIST_H_
