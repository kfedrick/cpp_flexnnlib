...
namespace flexnnet
{
   ...
   class BaseLayer : public flexnnet::NamedObject
   {
      /* ********************************************************************
   ...
   public:
       ...
       */
      template<class _NetInFunc, class _TransFunc> static BaseLayer create (unsigned int sz, const char *name = "BaseLayer")
      {
         return BaseLayer(name, sz, new _NetInFunc (), new _TransFunc ());
      }

      template<class _NetInFunc, class _TransFunc> static BaseLayer create (unsigned int sz, string &name)
      {
         return BaseLayer(name, sz, new _NetInFunc (), new _TransFunc ());
      }
       ...
       */
      BaseLayer (const string &_name, unsigned int sz, const NetInputFunctor *netinFunc, const TransferFunctor *transFunc);
   ...
   private:
      ...
      void initialize (unsigned int sz, const NetInputFunctor *netinFunc, const TransferFunctor *transFunc);
