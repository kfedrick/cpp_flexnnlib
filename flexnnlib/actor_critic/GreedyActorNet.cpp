...
GreedyActorNet::GreedyActorNet(const Pattern& stateVec, const set<string>& _actionSet, AdaptiveCriticNet* _adaptCritic) : ActorNet()
{
   Layer<NetSum, TanSig>& outputlayer = this->new_output_layer<NetSum, TanSig>(3,
         "output-layer");
