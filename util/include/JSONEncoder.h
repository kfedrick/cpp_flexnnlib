...
namespace flexnnet
{
   ...
   protected:
      ...
      static void ArrayToJSONObj (rapidjson::Value &_val, const flexnnet::Array<double> &_arr);
      static void JSONObjToArray (flexnnet::Array<double> &_arr, const rapidjson::Value &_val);
